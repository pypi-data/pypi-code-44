...
from plotpy.gui.widgets.ext_gui_lib import QwtPlotCanvas
...
def run():
    ...
    for benchmark in benchmarks:
        windows.append(benchmark.start(close=close))
    if not close:
        _app.exec_()
